...
export default function ContactCard({ contact, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className="group cursor-pointer bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-4 shadow-sm hover:shadow-md hover:border-amber-200 dark:hover:border-amber-800/60 hover:-translate-y-0.5 transition-all duration-200 active:scale-[0.98] flex flex-col gap-3"
    >
      {/* Top row */}
